      ...
      child: Container(
        ...
        child: Center(
          ...
          style: Theme.of(context)
              .textTheme
              .titleSmall!
              .copyWith(color: kTextWhiteColor, fontWeight: FontWeight.w500),
        )),
      ),
    );
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(
          ...
          children: [
            SvgPicture.asset(icon, height: 20.sp, width: 20.sp, color: kTextWhiteColor,),
            SizedBox(width: 2.w),
            Text(
              title,
              style: Theme.of(context).textTheme.titleSmall!.copyWith(
                  color: kTextWhiteColor, fontWeight: FontWeight.w500),
            ),
          ],
        )),
      ),
